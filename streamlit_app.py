    ...
    for idx, row in df.iterrows():
        ...
        with st.expander(f"**{row['Project_Name']}** • {row['Project_Type']} • {row.get('Customer', '—')}",
            ...
            with col_l:
                ...
                # Project Spec. 在下面一行一行（Light/Dark 都清楚）
...
st.markdown("---")
st.caption("Project Spec. displayed line by line • Works perfectly in Dark & Light theme • All data permanently saved")